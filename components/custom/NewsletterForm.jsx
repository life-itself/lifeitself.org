      ...
      <div className="rounded-3xl bg-secondary py-10 px-12 lg:py-20 lg:px-24 flex flex-col lg:flex-row items-stretch lg:items-center gap-8">
        <div className="flex-1 space-y-6">
          ...
          <p className="text-md lg:text-lg text-center lg:text-left text-primary">
            We're actively working for a radically wiser, weller world. Join our newsletter to be regularly updated with what's happening at Life Itself.
          </p>
        ...
        <div className="flex-1 !p-0">
          <iframe src="https://news.lifeitself.org/embed" width="480" height="320" style={{border:"1px solid #EEE", background:'white', margin: 'auto'}} frameborder="0" scrolling="no"></iframe>
        </div>
      </div>
    </div>
  )
